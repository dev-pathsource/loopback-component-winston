...
module.exports = function(options) {
	...
	function details(req, res) {
        ...
        // record full error in winston
        body: res.fullError || res.body
				// body: res.body
			}
		};
	...
	return function(req, res, next) {
		...
		res.once('finish', function() {
			var normalStatusCodes = [200, 201, 202, 304];
			level = normalStatusCodes.indexOf(res.statusCode) > -1 ? 'info' : 'error';
			meta = level === 'info' ? false : true;
